			...
			{owner == account ? (
				<div className={styles.wrapper}>
					...
					<span className={styles.prices}>
						{weiToEth(roomPriceByNumOfDay.toString())} Matic
					</span>{" "}
					<br />
					Transaction Fee :{" "}
					<span className={styles.prices}>0 Matic</span> <br />
				...
				<div className={styles.wrapper}>
					...
					Transaction Fee :{" "}
					<span className={styles.prices}>
						{weiToEth(transactionFee.toString())} Matic
					</span>{" "}
					<br />
					<hr className={styles.divider} />
					Total Fee :{" "}
					<span className={styles.prices}>
						{weiToEth(totalPrice.toString())} Matic
					</span>{" "}
					<br />
				</div>
			)}
